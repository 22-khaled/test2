...
# Configuration Key
firebaseConfig = {
  'apiKey': "AIzaSyAy5-2pzvv9zonc5bxa0yhwRQcEdzmJIj8",
  'authDomain': "test1-61897.firebaseapp.com",
  'projectId': "test1-61897",
  'databaseURL':"https://test1-61897-default-rtdb.europe-west1.firebasedatabase.app",
  'storageBucket': "test1-61897.appspot.com",
  'messagingSenderId': "1086583854399",
  'appId': "1:1086583854399:web:0998a0373286553864ef8a",
  'measurementId': "G-0CYBVE0LVF"
}
        ...
        if bio == 'Settings':  
            ...
            if nImage is not None:
                ...
                for img in Image.each():
                    ...
                    #st.write(img_choice)
                st.image(img_choice)
                exp = st.expand('Change Bio and Image')  
